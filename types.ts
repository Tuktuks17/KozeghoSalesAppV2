...
export const CLIENT_STATUS_VALUES = ['Lead', 'Prospect', 'Active Client', 'Inactive Client'] as const;
export type ClienteStatus = (typeof CLIENT_STATUS_VALUES)[number];

export const PROPOSAL_STATUS_VALUES = ['Draft', 'Pending Approval', 'Approved', 'Sent', 'Won', 'Lost', 'Doc Generated'] as const;
export type EstadoProposta = (typeof PROPOSAL_STATUS_VALUES)[number];

export const PROPOSAL_RESULT_VALUES = ['Open', 'Won', 'Lost'] as const;
export type ResultadoProposta = (typeof PROPOSAL_RESULT_VALUES)[number];
