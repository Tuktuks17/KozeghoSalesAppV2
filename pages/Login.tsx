    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4">
      <div className="bg-white w-full max-w-[420px] p-8 md:p-10 rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-100 flex flex-col items-center text-center">
        ...
        <div className="mb-8 flex flex-col items-center">
          {/* Logo Image */}
          <img 
            src="https://placehold.co/200x60/ffffff/0f172a?text=Kozegho&font=montserrat" 
            alt="Kozegho" 
            className="h-12 object-contain mb-4" 
          />
          <h1 className="text-2xl font-bold text-slate-900">Sign in to Sales App</h1>
          <p className="text-slate-500 text-sm mt-2">Use your company account to access your workspace.</p>
        </div>
        ...
        <div className="w-full space-y-6">
          ...
          <button 
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 bg-white border border-slate-200 hover:bg-slate-50 hover:border-slate-300 text-slate-700 font-medium py-3 px-4 rounded-xl transition-all group disabled:opacity-60 disabled:cursor-not-allowed"
          >
            {loading ? (
          ...
          <div className="relative flex items-center py-2">
            ...
            <span className="flex-shrink-0 mx-4 text-slate-400 text-xs font-medium uppercase tracking-wider">or sign in with email</span>
            <div className="flex-grow border-t border-slate-200"></div>
          </div>
